{{--
    ...
    @section('content')
        actividad.create template
    @endsection
--}}

<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Crear Actividad</h2>
    </x-slot>
              ...
              <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-2">
                  <div class="datepicker" data-mdb-toggle-button="false">
                      ...
                      <input type="text" value="{{old("fecha")}}" data-mdb-toggle="datepicker" placeholder="Selecciona una fecha" name="fecha" 
