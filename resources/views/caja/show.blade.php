<x-app-layout>
  <x-slot name="header">
    <h2 class="font-semibold text-xl text-gray-800 leading-tight">Caja {{ $caja->nombre }} ({{ $caja->identificador }})</h2>
  </x-slot>
      ...
      <div class="bg-white px-4 py-5 sm:p-6">
        <div class="grid grid-cols-6 gap-6">
          ...
          <div class="col-span-12 flex flex-col  sm:col-span-3">
            ...
            <form class="flex  max-w-max" action="{{ route('caja.show', $caja->id) }}" method="GET">
              @csrf
            ...
            <table class="min-w-full">
              <thead class="border-b">
                <tr>
                  ...
                  <th></th>
                  <th>
                        <a href="{{ route('caja.report', ['name' => $caja->nombre]) }}" target="_blank">
