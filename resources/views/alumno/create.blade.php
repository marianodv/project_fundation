...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Ingresar Alumno</h2>
    </x-slot>
            ...
            <div class="bg-white px-4 py-5 sm:p-6">
              <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input type="text" value="{{old("apellido")}}" name="apellido" id="apellido" autocomplete="apellido" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none">
                </div>
                <div class="col-span-6 sm:col-span-2">
                    <div class="datepicker" data-mdb-toggle-button="false">
                        ...
                        <input type="date" value="{{old("nacimiento")}}" placeholder="Selecciona una fecha" name="nacimiento" 
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <input type="text" value="{{old("mail")}}" name="mail" id="mail" autocomplete="mail" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none">
                </div>
                <div class="col-span-6 sm:col-span-3">
                    <label for="dni" class="form-label inline-block mb-2 text-gray-700">DNI</label>
                    <input type="text" value="{{old("dni")}}" name="dni" id="dni" autocomplete="dni" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none">
                </div>
                <div class="col-span-6 sm:col-span-3">
                    <label for="telefono" class="form-label inline-block mb-2 text-gray-700">Telefono</label>
                    <input type="text" value="{{old("telefono")}}" name="telefono" id="telefono" autocomplete="telefono" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none">
                </div>
              </div>
            </div>
